...
```{r}
einkaeufe <- read_csv(file = "/cloud/project/data/supermarkt/einkaeufe.csv")
preise <- read_csv(file = "/cloud/project/data/supermarkt/preise.csv")
kundenprofile <- read_csv(file = "/cloud/project/data/supermarkt/kundenprofile.csv")
```
...
```
# Text markieren und auskommentieren mit Ctrl + Shift + C
